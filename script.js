...
TDV["Tour"]["prototype"]["focusOverlayByName"] = function (as, at) {
  ...
  if (au !== undefined) {
    ...
    if (av) {
      var aw = av["get"]("class");
      var ax =
        aw == "VideoPanoramaOverlay" || aw == "QuadVideoPanoramaOverlay"
          ? av
          : av["get"]("items")[0x0];
      var ay, az;
      aw = ax["get"]("class");
      if (
        aw == "QuadVideoPanoramaOverlay" ||
        aw == "QuadHotspotPanoramaOverlayImage"
      ) {
...
TDV["Tour"]["Script"]["changePlayListWithSameSpot"] = function (cZ, d0) {
  ...
  if (d1 >= 0x0 && d0 >= 0x0 && d1 != d0) {
    ...
    if (
      ...
      if (
        d7["get"]("yaw") == undefined ||
        d7["get"]("pitch") == undefined ||
        d7["get"]("hfov") == undefined
      )
        return;
...
TDV["Tour"]["Script"]["clone"] = function (d8, d9) {
  ...
  if (db) {
    var dc =
      db + "_" + Math["random"]()["toString"](0x24)["substring"](0x2, 0xf);
    da["set"]("id", dc);
    this[dc] = da;
  }
...
TDV["Tour"]["Script"]["copyObjRecursively"] = function (dD) {
  ...
  for (var dF in dD) {
    ...
    if (typeof dG == "object" && dG !== null)
      dE[dF] = this["copyObjRecursively"](dD[dF]);
    else dE[dF] = dG;
  }
  return dE;
};
...
TDV["Tour"]["Script"]["getActivePlayerWithViewer"] = function (e0) {
  ...
  while (e2-- > 0x0) {
    ...
    if (e3["get"]("viewerArea") == e0) {
      ...
      if (
        (e4 == "PanoramaPlayer" &&
          (e3["get"]("panorama") != undefined ||
            e3["get"]("video") != undefined)) ||
        ((e4 == "VideoPlayer" || e4 == "Video360Player") &&
          e3["get"]("video") != undefined) ||
        (e4 == "PhotoAlbumPlayer" && e3["get"]("photoAlbum") != undefined) ||
        (e4 == "MapPlayer" && e3["get"]("map") != undefined)
      )
        return e3;
    }
  }
...
TDV["Tour"]["Script"]["sendAnalyticsData"] = function (hi, hj, hk) {
  if (window["dataLayer"]) {
    window["dataLayer"]["push"]({ event: hj, label: hk, category: hi });
  }
  if (!this["get"]("data")["tour"]["player"]["cookiesEnabled"]) return;
  if (window["ga"]) {
    window["ga"]("send", "event", hi, hj, hk);
  }
  if (window["gtag"]) {
    window["gtag"]("event", hj, { category: hi, label: hk });
  }
};
TDV["Tour"]["Script"]["initAnalytics"] = function () {
  var hm = this["getByClassName"]("Panorama");
  hm = hm["concat"](this["getByClassName"]("Video360"));
  hm = hm["concat"](this["getByClassName"]("Map"));
  for (var hp = 0x0, hs = hm["length"]; hp < hs; ++hp) {
    var ht = hm[hp];
    var hv = ht["get"]("data");
    var hw = hv ? hv["label"] : "";
    var hx = this["getOverlays"](ht);
    for (var hy = 0x0, hz = hx["length"]; hy < hz; ++hy) {
      var hA = hx[hy];
      var hB =
        hA["get"]("data") != undefined
          ? hw + "\x20-\x20" + hA["get"]("data")["label"]
          : hw;
      switch (hA["get"]("class")) {
        ...
        case "AreaHotspotMapOverlay":
          var hC = hA["get"]("areas");
          for (var hD = 0x0; hD < hC["length"]; ++hD) {
            hC[hD]["bind"](
              "click",
              this["sendAnalyticsData"]["bind"](this, "Hotspot", "click", hB),
              this,
              ![]
            );
          }
        ...
        case "TripodCapPanoramaOverlay":
          hA["bind"](
            "click",
            this["sendAnalyticsData"]["bind"](this, "Cap", "click", hB),
            this,
            ![]
          );
          break;
        ...
        case "VideoPanoramaOverlay":
          ...
          hA["bind"](
            "start",
            this["sendAnalyticsData"]["bind"](this, "Hotspot", "start", hB),
            this,
            ![]
          );
          break;
  ...
  var hE = this["getByClassName"]("UIComponent");
  for (var hp = 0x0, hs = hE["length"]; hp < hs; ++hp) {
    var hF = hE[hp];
    var hG = hF["getBindings"]("click");
    if (hG["length"] > 0x0) {
      var hH = hF["get"]("data")["name"];
      hF["bind"](
        "click",
        this["sendAnalyticsData"]["bind"](this, "Skin", "click", hH),
        this,
        ![]
      );
    }
  }
  var hI = this["mainPlayList"]
    ["get"]("items")
    ["concat"](this["getByClassName"]("PlayListItem"));
  var hJ = {};
  for (var hp = 0x0, hs = hI["length"]; hp < hs; ++hp) {
    var hK = hI[hp];
    var hm = hK["get"]("media");
    if (!(hm["get"]("id") in hJ)) {
      var hv = hm["get"]("data");
...
TDV["Tour"]["Script"]["initQuiz"] = function (hP, hQ, hR) {
  var hS = {
    timeout: {
      window: {
        ...
        shadow: true,
        buttonsContainer: { horizontalAlign: "center", gap: 10, width: "100%" },
      },
  ...
  var hT =
    hP["data"] && hP["data"]["titlesScale"] ? hP["data"]["titlesScale"] : 0x1;
  var hU =
    hP["data"] && hP["data"]["bodyScale"] ? hP["data"]["bodyScale"] : 0x1;
  ...
  var hY = hX
    ? /initial-scale=(\d+(\.\d+)?)/["exec"](hX["getAttribute"]("content"))
    : undefined;
  ...
  hW["scoreLandscapeConfig"] = {
    theme: {
      window: {
        title: { fontSize: 0x1e * hT, paddingTop: 0xa },
        stats: { height: 0x64 },
  ...
  if (hR === !![]) {
    i0["bind"](
      ...
      function () {
        if (
          (i0["get"](TDV["Quiz"]["PROPERTY"]["QUESTIONS_ANSWERED"]) +
            i0["get"](TDV["Quiz"]["PROPERTY"]["ITEMS_FOUND"])) /
            (i0["get"](TDV["Quiz"]["PROPERTY"]["QUESTION_COUNT"]) +
              i0["get"](TDV["Quiz"]["PROPERTY"]["ITEM_COUNT"])) ==
          0x1
        )
          i0["finish"]();
      }["bind"](this)
...
TDV["Tour"]["Script"]["_initSplitViewer"] = function (i9) {
  ...
  function ib(iB) {
    return (
      (parseFloat(iB["replace"]("%", "")) / 0x64) * i9["get"]("actualWidth")
    );
  }
  function ic(iC) {
  ...
  function ig(iE) {
    ...
    var iG =
      ...
      iE["get"]("camera")["get"]("initialPosition")["get"]("yaw");
    iF["setPosition"](
      iE["get"]("yaw") + iG,
      iE["get"]("pitch"),
      iE["get"]("roll"),
  ...
  i9["bind"](
    ...
    function () {
      is["set"](
        "left",
        (i9["get"]("actualWidth") - is["get"]("actualWidth")) * 0.5
      );
      ia();
    },
    this
...
TDV["Tour"]["Script"]["_initTwinsViewer"] = function (j0) {
  ...
  function j2(jp) {
    return (
      (parseFloat(jp["replace"]("%", "")) / 0x64) * j0["get"]("actualWidth")
    );
  }
  function j3(jq) {
  ...
  function j5(js) {
    ...
    var ju =
      ...
      js["get"]("camera")["get"]("initialPosition")["get"]("yaw");
    jt["setPosition"](
      js["get"]("yaw") + ju,
      js["get"]("pitch"),
      js["get"]("roll"),
  ...
  j0["bind"](
    ...
    function () {
      jg["set"](
        "left",
        (j0["get"]("actualWidth") - jg["get"]("actualWidth")) * 0.5
      );
      j1();
    },
    this
...
TDV["Tour"]["Script"]["_initItemWithComps"] = function (
  ...
  var jY = function (k6) {
    ...
    if (k8) {
      ...
      if (k7["indexOf"]("Slide") != -0x1)
        k8["set"](
          k6 ? "from" : "to",
          jQ["get"](jQ["get"]("class") == "SlideInEffect" ? "from" : "to")
        );
    }
    return k8;
  };
    ...
    for (var k9 = 0x0, ka = jN["length"]; k9 < ka; ++k9) {
      ...
      if (jS > 0x0) {
        ...
        if (this["existsKey"](kc)) {
          if (this["getKey"](kc))
            this["setComponentVisibility"](kb, !![], 0x0, jY(!![]));
  ...
  var k1 = function (kf, kg, kh) {
    var ki = function () {
      var kj = function (kn, ko, kp) {
        jX["setComponentVisibility"](
          kn,
          ko,
          kg,
          kp,
          ko ? "showEffect" : "hideEffect",
          ![]
        );
        if (kh > 0x0) {
...
TDV["Tour"]["Script"]["openLink"] = function (kE, kF) {
  ...
  if (kG && kF == "_blank") {
    ...
    if (
      (["pdf", "zip", "xls", "xlsx"]["indexOf"](kI) == -0x1 ||
        kE["startsWith"]("file://")) &&
...
TDV["Tour"]["Script"]["pauseCurrentPlayers"] = function (kM) {
  ...
  while (kO-- > 0x0) {
    var kP = kN[kO];
    if (
      kP["get"]("state") == "playing" ||
      (kP["get"]("data") && kP["get"]("data")["playing"]) ||
      (kP["get"]("viewerArea") &&
        kP["get"]("viewerArea")["get"]("id") == this["getMainViewer"]()) ||
      (kP["get"]("camera") &&
        kP["get"]("camera")["get"]("idleSequence") &&
        kP["get"]("camera")["get"]("timeToIdle") > 0x0 &&
        kP["get"]("state") == "playing")
    ) {
...
TDV["Tour"]["Script"]["pauseGlobalAudios"] = function (kV, kW) {
  ...
  if (window["currentGlobalAudios"] != undefined)
    l1 = l1["concat"](
      Object["values"](window["currentGlobalAudios"])["map"](function (l6) {
  ...
  for (var kZ = 0x0, l4 = l1["length"]; kZ < l4; ++kZ) {
    ...
    if (
      l5 &&
      l5["get"]("state") == "playing" &&
      (kV == undefined || kV["indexOf"](l5) == -0x1)
    ) {
      if (l5["get"]("id") in l2) {
        l5["stop"]();
      } else {
...
TDV["Tour"]["Script"]["playGlobalAudio"] = function (lL, lM, lN, lO) {
  ...
  lQ[lL["get"]("id")] = { audio: lL, asBackground: lO || ![], allowResume: lM };
  ...
  for (var mM = 0x0, mN = mL["length"]; mM < mN; ++mM) {
    ...
    for (var mQ = 0x0, mR = mP["length"]; mQ < mR; ++mQ) {
      ...
      if (
        mT !== undefined &&
        mT["label"] == mJ &&
        mS["get"]("player")["get"]("viewerArea") == mK
      ) {
...
TDV["Tour"]["Script"]["executeAudioAction"] = function (
  ...
  if (mW && !(mW === !![])) {
    ...
    for (var n4 = 0x0; n4 < n3["length"]; ++n4) {
      ...
      if (
        n7 &&
        n7["get"]("player") &&
        n7["get"]("player")["get"]("viewerArea") == n2
      ) {
        n0 = n5;
  ...
  var nf = function () {
    for (var nz = 0x0, nA = mU["length"]; nz < nA; ++nz) {
      if (this["getGlobalAudio"](mU[nz])["get"]("state") == "playing")
        return !![];
    }
    return ![];
  }["bind"](this);
...
TDV["Tour"]["Script"]["setMediaBehaviour"] = function (nK, nL, nM, nN) {
  ...
  var nQ = function () {
    ...
    var od = nZ["get"]("media");
    if (
      od["get"]("class") != "Panorama" ||
      (od["get"]("camera") != undefined &&
        od["get"]("camera")["get"]("initialSequence") != undefined)
    ) {
  ...
  var nT = function (of) {
    ...
    var og = nZ["get"]("media");
    if (
      (og["get"]("class") == "Video360" || og["get"]("class") == "Video") &&
      og["get"]("loop") == !![] &&
      !of
    )
      return;
    ...
    if (o7 && o6 != -0x1) {
      if (o7) {
        if (
          o6 > 0x0 &&
          o7["get"]("movements")[o6 - 0x1]["get"]("class") ==
    ...
    if (o5) {
      ...
      if (
        (nW == this["mainPlayList"] || nW["get"]("items")["length"] > 0x1) &&
        (or == undefined || or == nZ["get"]("media"))
      ) {
  ...
  if (!nM) {
    ...
    var nV =
      nU != -0x1
        ? nK["get"]("items")[nK["get"]("selectedIndex")]["get"]("player")
        : this["getActivePlayerWithViewer"](this["getMainViewer"]());
    if (nV) {
  ...
  if (
    (nK["get"]("selectedIndex") == nL && o1 == nZ["get"]("media")) ||
    nY == -0x1
  ) {
    return;
  }
  if (nK["get"]("selectedIndex") == nL && o1 != nZ["get"]("media"))
    nK["set"]("selectedIndex", -0x1);
...
TDV["Tour"]["Script"]["setOverlayBehaviour"] = function (ov, ow, ox, oy) {
  var oz = function () {
    switch (ox) {
      ...
      case "togglePlayStop":
        if (ov["get"]("state") == "playing")
          ov[ox == "togglePlayPause" ? "pause" : "stop"]();
        else ov["play"]();
        break;
    }
    if (oy) {
  ...
  if (
    oy &&
    window["overlaysDispatched"] != undefined &&
    ov["get"]("id") in window["overlaysDispatched"]
  )
    return;
  ...
  if (oA != undefined) {
    ...
    if (
      oA["get"]("items")["indexOf"](oB) != oA["get"]("selectedIndex") ||
      (this["isPanorama"](oB["get"]("media")) &&
        oC["get"]("rendererPanorama") != oB["get"]("media"))
    ) {
      var oD = function (oF) {
...
TDV["Tour"]["Script"]["setOverlaysVisibilityByTags"] = function (
  ...
  var p9 = p6
    ? this["getPanoramaOverlaysByTags"](p6, p4, p7)
    : this["getOverlaysByTags"](p4, p7);
...
TDV["Tour"]["Script"]["setPanoramaCameraWithCurrentSpot"] = function (pj, pk) {
  ...
  if (
    pl != undefined &&
    (pl["get"]("class")["indexOf"]("Panorama") != -0x1 ||
      pl["get"]("class") == "Video360")
  ) {
    var pm = pj["get"]("media");
...
TDV["Tour"]["Script"]["setSurfaceSelectionHotspotMode"] = function (pz) {
  ...
  pA["forEach"](function (pF) {
    var pG = pF["get"]("data");
    if (pG && pG["hasPanoramaAction"] == !![])
      pF["set"]("enabledInSurfaceSelection", pC);
  });
...
TDV["Tour"]["Script"]["showPopupMedia"] = function (qo, qp, qq, qr, qs, qt) {
  ...
  var qx = function () {
    ...
    if (!qL) {
      var qM =
        qB("closeButtonIconHeight") +
        qB("closeButtonPaddingTop") +
        qB("closeButtonPaddingBottom");
      var qN =
        qu["getPixels"](qB("titleFontSize")) +
        qB("titlePaddingTop") +
        qB("titlePaddingBottom");
      qL = qM > qN ? qM : qN;
...
TDV["Tour"]["Script"]["showPopupPanoramaOverlay"] = function (
  ...
  if (
    rB["get"]("visible") ||
    (!rJ && this["zoomImagePopupPanorama"]["get"]("visible"))
  )
    return;
  this["getMainViewer"]()["set"]("toolTipEnabled", ![]);
  if (!rJ) {
    ...
    var rR = function () {
      ...
      this["showPopupImage"](
        rD,
        rE,
        rB["get"]("popupMaxWidth"),
        rB["get"]("popupMaxHeight"),
        null,
        null,
        rC,
        rF,
...
TDV["Tour"]["Script"]["startPanoramaWithCamera"] = function (sn, so) {
  ...
  var sq =
    window["currentPanoramasWithCameraChanged"] == undefined ||
    !(sn["get"]("id") in window["currentPanoramasWithCameraChanged"]);
  var sr = [];
  for (var st = 0x0, su = sp["length"]; st < su; ++st) {
    ...
    for (var sx = 0x0, sy = sw["length"]; sx < sy; ++sx) {
      ...
      if (
        sA["get"]("media") == sn &&
        (sA["get"]("class") == "PanoramaPlayListItem" ||
          sA["get"]("class") == "Video360PlayListItem")
      ) {
        if (sq) {
          sr["push"]({ camera: sA["get"]("camera"), item: sA });
        }
        sA["set"]("camera", so);
      }
    }
  ...
  if (th) {
    if (tc) {
      ...
      if (tk && tk["get"]("class") == "PanoramaPlayer") {
        var tl = tk["get"]("yaw");
        var tm = tk["get"]("pitch");
        if (!isNaN(tl) && !isNaN(tm))
          tg += "&yaw=" + tl["toFixed"](0x2) + "&pitch=" + tm["toFixed"](0x2);
      }
    }
    if (td) {
...
TDV["Tour"]["Script"]["updateVideoCues"] = function (tM, tN) {
  ...
  var tT = function (tU) {
    ...
    for (var tW = 0x0, tX = tR["length"]; tW < tX; ++tW) {
      ...
      if (
        tV["indexOf"](tY) == -0x1 &&
        (tY["get"]("startTime") > tQ["get"]("currentTime") ||
          tY["get"]("endTime") < tQ["get"]("currentTime") + 0.5)
      ) {
        tY["trigger"]("end");
      }
    }
    ...
    if (this["get"]("isMobile") && this["get"]("orientation") == "landscape") {
      ...
      if (ug > 0x0) {
        uf = this["mixObject"](uf || {}, {
          theme: { window: { width: undefined, left: ug, right: ug } },
        });
      }
    }
    var uh =
...
TDV["Tour"]["Script"]["stopTextToSpeech"] = function (uq) {
  if (
    ...
    (uq == undefined || this["t2sLastID"] == uq)
  ) {
  ...
  if ((ut != undefined && this["t2sLastID"] != ut) || ut == undefined) {
    ...
    if (window["speechSynthesis"]) {
      ...
      if (!ux["isIOS"]()) {
        ...
        uD("play", { text: us, androidCallback: "onTTSEnd" });
      } else {
        console["error"](
...
TDV["Tour"]["Script"]["htmlToPlainText"] = function htmlToPlainText(v0, v1) {
  ...
  if (
    vc["length"] === 0x0 ||
    vc["lastIndexOf"]("\x0a") !== vc["length"] - 0x1
  ) {
    vc += "\x0a";
  }
  return vc;
  ...
  if (vR && vQ == "WebFrame") {
    ...
    vN["set"](
      ...
      "lib/pdfjs/web/viewer.html?file=" +
        encodeURIComponent(
          vS["substring"](0x0, vS["lastIndexOf"]("/")) + "/" + vO
        )
    );
  } else {
    ...
    var vU =
      ...
      "</iframe>";
    var vV = /^((?!chrome|android|crios|ipad|iphone).)*safari/i["test"](
      navigator["userAgent"]
    );
    var vW =
    ...
    if (vQ == "WebFrame") {
      ...
      vN["set"](
        "content",
        "data:text/html;charset=utf-8," + encodeURIComponent(vW)
      );
    }
  }
};
